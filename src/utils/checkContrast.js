...
console.log(`  ${textOnBg >= 7 ? '[AAA]' : textOnBg >= 4.5 ? '[AA]' : '[FAIL]'} for normal text\n`);
...
console.log(`  ${greenOnBg >= 7 ? '[AAA]' : greenOnBg >= 4.5 ? '[AA]' : '[FAIL]'} for normal text`);
...
console.log(`  ${yellowOnBg >= 7 ? '[AAA]' : yellowOnBg >= 4.5 ? '[AA]' : '[FAIL]'} for normal text\n`);
...
console.log(`  ${cyanOnBg >= 7 ? '[AAA]' : cyanOnBg >= 4.5 ? '[AA]' : '[FAIL]'} for normal text\n`);
...
console.log(`  ${redOnBg >= 4.5 ? '[AA]' : '[FAIL]'} for warnings/errors\n`);
...
console.log(`  ${goldOnBg >= 7 ? '[AAA]' : goldOnBg >= 4.5 ? '[AA]' : '[FAIL]'} for normal text\n`);
