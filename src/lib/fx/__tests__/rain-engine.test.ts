...
import { partOffset, rippleBoost, burstFactor, GLYPHS, RADIUS, PART } from '../rain-engine';
import { RAIN_DARK, RAIN_LIGHT, resolvePalette, tintedPalette, mixRgb, hexToRgb } from '../rain-palettes';

/**
 * These lock the visual contract from the design handoff. They are here so the
 * engine can be optimised without anyone having to eyeball whether the rain still
 * looks right.
 */
...
describe('burst', () => {
  ...
  test('is inert before it has fired', () => {
