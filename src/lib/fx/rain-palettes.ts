...
export interface RainPalette {
  ...
  trail: string;
  head: string;
  /** The lit-up colour: glyphs the pointer is parting, and glyphs on a click ripple. */
  spark: string;
}
...
/** The accent (blue pill) palette: the trail takes the accent, head and spark lift towards white. */
