...
export function MatrixRain() {
  ...
  return (
    <canvas
      ref={canvasRef}
      aria-hidden="true"
      className="pointer-events-none fixed inset-0 -z-10 transition-opacity duration-1000 dark:opacity-35 opacity-[0.05] max-sm:dark:opacity-20 max-sm:opacity-[0.03]"
    />
  );
}
